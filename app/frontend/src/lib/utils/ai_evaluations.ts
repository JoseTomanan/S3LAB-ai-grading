...
export const GET_E_A_R_Q = (i: GetSpecificEvaluationResponse) => i.expected_answer_rubric_questions.split(';');
export const GET_SCORES = (i: GetSpecificEvaluationResponse) => i.scores.split(';');
